                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <tr>
                              ...
                              <th class="hidden-phone">板块图标</th>
                               <th class="hidden-phone">板块名</th>
                                 <th class="hidden-phone" id="sort">分类排序</th>
                        ...
                        <%--   <a click="sort(${t.id},${t.sort})" class="btn btn-success">↑</a> --%>
                          ...
                          <tbody id="rq">
                          <c:forEach var="t" items="${sessionScope.plist}">
                          <tr class="odd gradeX" id="cla${t.id}">
                               ...
                               <td class="hidden-phone"><a class="btn btn-success" href="plateupdatef.do?id=${t.id}">编辑</a>&nbsp;<a class="btn btn-danger" onclick="delet(${t.id})">删除</a></td>
                          </tr>
                          </c:forEach>
                          </tbody>
                          </table>
