                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                        ...
                        <%--   <a click="sort(${t.id},${t.sort})" class="btn btn-success">↑</a> --%>
                          ...
                          <tbody id="rq">
                          <c:forEach var="t" items="${sessionScope.ulist}">
                          <tr class="odd gradeX" id="cla${t.id}">
                               <td><input type="checkbox" class="checkboxes" value="1" /></td>
                               <td>
                               <img class="fd img-circle" height="50px" width="50px" src="${t.head}">
                               </td>
                               <td>${t.name}</td>
                                <td>${t.introduction}</td>
                                <th class="hidden-phone">${t.sex}</th>
                                <th class="hidden-phone">${t.ex}</th>
                                <th class="hidden-phone"> <img  src="${t.level.image}"></th>
                                <th class="hidden-phone">${t.lasttime}</th>
